...
#~~~~~~~~~~~~~~~~~~~~~~~~
# python step07_yolov8_image_custom_weights_checker.py --src_dir c:/perimeter_dataset/test/images --weights_fname c:/my_campy/SafeCity_Voronezh/dataset_preparation/my_weights/20240208_fire_garbage/best.pt --classes_fname c:/my_campy/SafeCity_Voronezh/dataset_preparation/classes.txt --threshold 0.5 --dst_dir c:/perimeter_dataset_custom_check
#~~~~~~~~~~~~~~~~~~~~~~~~
