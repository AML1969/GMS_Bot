...
# python step01_roboflow3dir_to_1dir.py --src_dir c:/perimeter_raw_dataset/garbage/202/Garbage.v4-original.yolov8 --dst_dir c:/perimeter_raw_dataset/garbage/202_01 --class_name garbage --class_index 1 --new_class_index 2
# python step01_roboflow3dir_to_1dir.py --src_dir c:/perimeter_raw_dataset/garbage/203/HumanDetector.v1i.yolov8 --dst_dir c:/perimeter_raw_dataset/garbage/203_01 --class_name garbage --class_index 1 --new_class_index 2
#~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    for j in range(len(txt_lst)):
      ...
      with open(txt_fname1, 'r', encoding='utf-8') as input_file:
        ...
        for line in lines:
          ...
          if 5 == len(fields5):
            if fields5[0] == str(class_index):
              #~ изменяем индекс класса объекта
              fields5[0] = str(new_class_index)
              # print(f'[INFO]    --->fields5: len: {len(fields5)}: `{fields5}`, fields5[0]: `{fields5[0]}`')
  ...
  for file_name in os.listdir(input_dir):
    if file_name.endswith(".jpg"):
      ...
      if not os.path.exists(annotation_path):
        continue
      #~~~~~~~~~~~~~~~~~~~~~~~~
      # print(f'[INFO] annotation_path: `{annotation_path}`')
