...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
def copy_img_lbl_pairs(src_dir: str, dst_dir: str):
  ...
  if os.path.exists(src_dir0):
    ...
    copy2_img_lbl_pairs(src_dir, img_lst, dst_dir, False)
  #~~~~~~~~~~~~~~~~~~~~~~~~
...
def main_step09_pretrainer(src_dir: str, classes_fname: str, dst_dir: str, img_size: int, train_percent: int, valid_percent: int):
  ...
  copy_img_lbl_pairs(src_dir, temp1_dir)
  ...
  draw_bounding_boxes(dst_dir, bbox_dir)
